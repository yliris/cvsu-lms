...
import Login.LoginInstructorFrame;
...
public class InstructorForgotPassword1Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        instructor_Continue_Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/buttons/Continue_Button.png"))); // NOI18N
        ...
        email_field.setBackground(new java.awt.Color(33, 125, 23));
        email_field.setFont(new java.awt.Font("Copperplate Gothic Light", 0, 12)); // NOI18N
        email_field.setForeground(new java.awt.Color(255, 255, 255));
        email_field.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        getContentPane().add(email_field, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, 200, 30));

        field.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/fields/Email_Field.png"))); // NOI18N
        getContentPane().add(field, new org.netbeans.lib.awtextra.AbsoluteConstraints(367, 260, -1, -1));

        instruction.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/backgrounds/PasswordResetInstruction.png"))); // NOI18N
        getContentPane().add(instruction, new org.netbeans.lib.awtextra.AbsoluteConstraints(267, 150, -1, -1));

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/backgrounds/ForgotPassword.png"))); // NOI18N
    ...
    private void instructor_Continue_ButtonMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_instructor_Continue_ButtonMouseReleased
        instructor_Continue_Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/buttons/Continue_Button.png")));
    ...
    private void instructor_Continue_ButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_instructor_Continue_ButtonMousePressed
        instructor_Continue_Button.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/buttons/Continue_ButtonClick.png")));
    ...
    private void instructor_Continue_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_instructor_Continue_ButtonActionPerformed
        String username = email_field.getText(); // Get email input
